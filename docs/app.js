const plugins = [{
  ...
  name: 'vps-security-auditor', displayName: 'VPS Security Auditor', category: 'Security & Privacy', icon: 'VSA', version: '0.1.0', description: 'Audita firewall, puertos, SSH, usuarios y fail2ban sin aplicar cambios.', capabilities: ['VPS', 'SSH', 'Firewall', 'Hardening'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-security-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-backup-manager', displayName: 'VPS Backup Manager', category: 'Security & Privacy', icon: 'VBM', version: '0.1.0', description: 'Planifica backups y restauraciones verificables de datos y configuración.', capabilities: ['Backups', 'Docker Volumes', 'PostgreSQL', 'Recovery'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-backup-manager', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-resource-monitor', displayName: 'VPS Resource Monitor', category: 'Developer Tools', icon: 'VRM', version: '0.1.0', description: 'Mide CPU, memoria, disco, inodos y carga sin instalar agentes.', capabilities: ['CPU', 'Memory', 'Disk', 'Capacity'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-resource-monitor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  ...
  name: 'vps-incident-responder', displayName: 'VPS Incident Responder', category: 'Developer Tools', icon: 'VIR', version: '0.1.0', description: 'Correlaciona señales del sistema, red y Docker para investigar incidentes.', capabilities: ['Incident Response', 'SSH', 'Docker', 'Diagnostics'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-incident-responder', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  ...
  name: 'vps-cost-capacity-auditor', displayName: 'VPS Cost & Capacity Auditor', category: 'Developer Tools', icon: 'VCA', version: '0.1.0', description: 'Relaciona recursos, crecimiento y eficiencia sin inventar precios.', capabilities: ['Capacity', 'Resources', 'Cost Analysis', 'Docker'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-cost-capacity-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-network-diagnostics', displayName: 'VPS Network Diagnostics', category: 'Developer Tools', icon: 'VND', version: '0.1.0', description: 'Diagnostica DNS, latencia, puertos y conectividad HTTP/TLS.', capabilities: ['DNS', 'Networking', 'Latency', 'Ports'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-network-diagnostics', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-service-exposure-auditor', displayName: 'VPS Service Exposure Auditor', category: 'Security & Privacy', icon: 'VSEA', version: '0.1.0', description: 'Correlaciona listeners públicos, puertos Docker, firewall y reverse proxy.', capabilities: ['Port Exposure', 'Docker', 'Firewall', 'Reverse Proxy'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-service-exposure-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-observability-auditor', displayName: 'VPS Observability Auditor', category: 'Developer Tools', icon: 'VOA', version: '0.1.0', description: 'Audita métricas, logs, healthchecks y alertas de un VPS.', capabilities: ['Metrics', 'Logs', 'Healthchecks', 'Alerting'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-observability-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-deployment-readiness-auditor', displayName: 'VPS Deployment Readiness Auditor', category: 'Developer Tools', icon: 'VDRA', version: '0.1.0', description: 'Valida Compose, healthchecks, imágenes y rollback antes de desplegar.', capabilities: ['Docker Compose', 'Preflight', 'Healthchecks', 'Rollback'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-deployment-readiness-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-backup-restore-verifier', displayName: 'VPS Backup Restore Verifier', category: 'Developer Tools', icon: 'VBRV', version: '0.1.0', description: 'Verifica integridad, cobertura y recuperabilidad de backups.', capabilities: ['Backup Integrity', 'Restore Readiness', 'Checksums', 'Recovery Planning'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-backup-restore-verifier', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-configuration-drift-auditor', displayName: 'VPS Configuration Drift Auditor', category: 'Developer Tools', icon: 'VCDA', version: '0.1.0', description: 'Detecta diferencias entre configuración declarada y estado activo.', capabilities: ['Configuration Drift', 'Docker', 'Systemd', 'Nginx'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-configuration-drift-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-container-security-auditor', displayName: 'VPS Container Security Auditor', category: 'Security & Privacy', icon: 'VCSA', version: '0.1.0', description: 'Audita privilegios, capabilities, mounts y aislamiento Docker.', capabilities: ['Docker Security', 'Capabilities', 'Mounts', 'Isolation'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-container-security-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-image-provenance-auditor', displayName: 'VPS Image Provenance Auditor', category: 'Security & Privacy', icon: 'VIPA', version: '0.1.0', description: 'Audita procedencia, digest y coherencia de imágenes Docker.', capabilities: ['Image Provenance', 'Digests', 'Registry', 'Supply Chain'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-image-provenance-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-docker-network-isolation-auditor', displayName: 'VPS Docker Network Isolation Auditor', category: 'Security & Privacy', icon: 'VDNIA', version: '0.1.0', description: 'Audita segmentación, redes compartidas y exposición entre contenedores.', capabilities: ['Docker Networks', 'Isolation', 'Segmentation', 'Port Exposure'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-docker-network-isolation-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-docker-resource-limits-auditor', displayName: 'VPS Docker Resource Limits Auditor', category: 'Developer Tools', icon: 'VDRLA', version: '0.1.0', description: 'Audita CPU, memoria, PIDs, OOM y políticas de reinicio por contenedor.', capabilities: ['CPU Limits', 'Memory Limits', 'PIDs', 'OOM Policy'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-docker-resource-limits-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-dependency-topology-auditor', displayName: 'VPS Dependency Topology Auditor', category: 'Developer Tools', icon: 'VDTA', version: '0.1.0', description: 'Mapea dependencias, puntos únicos de fallo y blast radius.', capabilities: ['Dependency Graph', 'Blast Radius', 'Nginx', 'Docker'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-dependency-topology-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-backup-job-monitor', displayName: 'VPS Backup Job Monitor', category: 'Developer Tools', icon: 'VBJM', version: '0.1.0', description: 'Audita ejecución, frescura, fallos y cobertura de jobs de backup.', capabilities: ['Backup Jobs', 'Cron', 'Systemd Timers', 'Freshness'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-backup-job-monitor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-tls-renewal-monitor', displayName: 'VPS TLS Renewal Monitor', category: 'Security & Privacy', icon: 'VTRM', version: '0.1.0', description: 'Audita Certbot, expiración y coherencia de certificados TLS.', capabilities: ['TLS Renewal', 'Certbot', 'Certificate Expiry', 'HTTPS'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-tls-renewal-monitor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'vps-dns-email-auth-auditor', displayName: 'VPS DNS & Email Auth Auditor', category: 'Security & Privacy', icon: 'VDEA', version: '0.1.0', description: 'Audita DNS, DNSSEC y autenticación de correo SPF, DKIM y DMARC.', capabilities: ['DNS', 'DNSSEC', 'SPF', 'DKIM', 'DMARC'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-dns-email-auth-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  ...
  name: 'vps-image-vulnerability-sbom-auditor', displayName: 'VPS Image Vulnerability & SBOM Auditor', category: 'Security & Privacy', icon: 'VIVSA', version: '0.1.0', description: 'Audita CVE y SBOM de imágenes Docker presentes en un VPS con trivy/grype/syft solo si están instalados, en modo lectura y sin descargar, transmitir ni modificar imágenes ni contenedores.', capabilities: ['Image Vulnerabilities', 'CVE', 'SBOM', 'Trivy', 'Grype', 'Syft', 'Supply Chain'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-image-vulnerability-sbom-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  ...
  name: 'vps-log-retention-auditor', displayName: 'VPS Log Retention Auditor', category: 'Developer Tools', icon: 'VLRA', version: '0.1.0', description: 'Audita retención y crecimiento de logs de un VPS (journald y logging de Docker) en modo lectura sin borrar, truncar, rotar, reiniciar servicios ni cambiar configuración.', capabilities: ['journald', 'Docker Logging', 'Log Retention', 'Disk Usage'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/vps-log-retention-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  ...
  name: 'agent-tools-runtime-poc', displayName: 'Agent Tools Runtime POC', category: 'Developer Tools', icon: 'ATR', version: '0.7.0', description: 'Runtime MCP instalable basado en just-bash para cargar adaptadores MCP, REST y CLI progresivamente desde skills, con validadores, sesiones, preflight de CLIs, OAuth host-side y confirmación.', capabilities: ['just-bash', 'MCP', 'REST API', 'CLI', 'Preflight', 'OAuth', 'Validation'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/agent-tools-runtime-poc', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}];
const analyses = [{
