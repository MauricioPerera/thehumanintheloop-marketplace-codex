const plugins = [{
  ...
  name: 'agent-tools-runtime-poc', displayName: 'Agent Tools Runtime POC', category: 'Developer Tools', icon: 'ATR', version: '0.9.1', description: 'Runtime MCP instalable basado en just-bash para cargar adaptadores MCP, REST y CLI progresivamente desde skills, con catálogo estructurado, validadores, sesiones, preflight de CLIs, OAuth host-side y confirmación.', capabilities: ['just-bash', 'MCP', 'REST API', 'CLI', 'Adapter catalog', 'Preflight', 'OAuth', 'Validation'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/agent-tools-runtime-poc', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}];
const analyses = [{
