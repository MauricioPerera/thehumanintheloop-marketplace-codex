const plugins = [{
  ...
  name: 'repo-quality-gate', displayName: 'Repo Quality Gate', category: 'Productivity', icon: 'RQ', version: '0.1.0', description: 'Revisa repositorios antes de commit, PR, release o despliegue.', capabilities: ['Quality', 'CI', 'Release'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/repo-quality-gate', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'technical-docs-linter', displayName: 'Technical Docs Linter', category: 'Productivity', icon: 'TD', version: '0.1.0', description: 'Valida README, documentación API, ejemplos, comandos y enlaces.', capabilities: ['Docs', 'API', 'Examples'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/technical-docs-linter', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'accessibility-auditor', displayName: 'Accessibility Auditor', category: 'Productivity', icon: 'A11Y', version: '0.1.0', description: 'Audita HTML, ARIA, nombres accesibles, formularios y teclado.', capabilities: ['A11y', 'HTML', 'WCAG'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/accessibility-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'privacy-risk-auditor', displayName: 'Privacy Risk Auditor', category: 'Productivity', icon: 'PR', version: '0.1.0', description: 'Detecta PII, secretos, credenciales y configuraciones de riesgo.', capabilities: ['Privacy', 'PII', 'Secrets'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/privacy-risk-auditor', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'release-readiness', displayName: 'Release Readiness', category: 'Productivity', icon: 'RR', version: '0.1.0', description: 'Comprueba si un repositorio está listo para release o despliegue.', capabilities: ['Release', 'CI', 'Checklist'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/release-readiness', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'prompt-contract-linter', displayName: 'Prompt Contract Linter', category: 'Productivity', icon: 'PC', version: '0.1.0', description: 'Valida objetivos, entradas, salidas, límites y criterios de aceptación.', capabilities: ['Prompts', 'Contracts', 'QA'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/prompt-contract-linter', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'research-evidence-builder', displayName: 'Research Evidence Builder', category: 'Productivity', icon: 'RE', version: '0.1.0', description: 'Construye informes con fuentes, fechas, citas y matriz de evidencia.', capabilities: ['Research', 'Sources', 'Evidence'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/research-evidence-builder', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'brand-voice-validator', displayName: 'Brand Voice Validator', category: 'Productivity', icon: 'BV', version: '0.1.0', description: 'Valida tono, vocabulario y claims contra una guía editorial.', capabilities: ['Brand', 'Voice', 'Editorial'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/brand-voice-validator', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}, {
  name: 'api-contract-linter', displayName: 'API Contract Linter', category: 'Productivity', icon: 'API', version: '0.1.0', description: 'Audita contratos OpenAPI, rutas, operaciones y respuestas.', capabilities: ['OpenAPI', 'Contracts', 'API'], url: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex/tree/main/plugins/api-contract-linter', marketplace: 'https://github.com/MauricioPerera/thehumanintheloop-marketplace-codex', codexUrl: 'codex://new', claudeMarketplace: 'thehumanintheloop-marketplace-claude'
}];
const analyses = [{
