"""Reject cron audit plans that execute or edit scheduled jobs."""
from pathlib import Path
import argparse
FORBIDDEN=('crontab -e','crontab -r','systemctl enable','systemctl disable','systemctl start','systemctl stop')
def main():
